...
///////////////////////////////////////////////////////
// W25Q64 CS 引脚设置
#define    W25Q64_CS_GPIO_CLK_EN()  __HAL_RCC_GPIOB_CLK_ENABLE()
#define    W25Q64_CS_GPIOx          GPIOB
#define    W25Q64CSout              PBout
#define    pinW25Q64CS              PIN_12

#define    W25Q64_CS_PIN           (1 << pinW25Q64CS) // GPIO_PIN_12     
#define    W25Q64_CS_1()            W25Q64CSout(pinW25Q64CS)=1
#define    W25Q64_CS_0()            W25Q64CSout(pinW25Q64CS)=0
...
#define     ASC40_START_ADRESS      0x44000     //
