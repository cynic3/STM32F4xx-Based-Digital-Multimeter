...
#define     LCD_RST_GPIOx               GPIOD        // LCD_RST 驱动引脚所在的端口
#define     pinLCDRST                   PIN_13
#define     LCDRSTout                   PDout

#define     LCD_RST_PIN                (1 << pinLCDRST) //GPIO_PIN_13
#define     LCD_RST_ON()                LCDRSTout(pinLCDRST)=0 
#define     LCD_RST_OFF()               LCDRSTout(pinLCDRST)=1

// LCD 背光引脚
#define     LCD_BKLED_GPIO_CLK_ENABLE() __HAL_RCC_GPIOF_CLK_ENABLE()
#define     LCD_BKLED_GPIOx             GPIOF        // LCD_BKLED 驱动引脚所在的端口
#define     pinLCDBKLED                 PIN_14
#define     LCDBKLEDout                 PFout

#define     LCD_BKLED_PIN              (1 << pinLCDBKLED) // GPIO_PIN_14
#define     LCD_BKLED_ON()              LCDBKLEDout(pinLCDBKLED)=1 
#define     LCD_BKLED_OFF()             LCDBKLEDout(pinLCDBKLED)=0
/////////////////////////////////////////////////////////////////////////////////////
